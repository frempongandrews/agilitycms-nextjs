                    ...
                    <div className="flex-1 md:flex md:items-center md:justify-between">
                        <div className="flex flex-col -mx-4 md:flex-row md:items-center md:mx-8">
                            <Link href={`/characters`}>
                                <a className="px-2 py-1 mx-2 mt-2 text-sm font-medium text-gray-700 transition-colors duration-200 transform rounded-md md:mt-0 hover:bg-gray-300">Characters</a>
                            </Link>
                        ...
                        <div className="flex items-center mt-4 md:mt-0">
                            ...
                            <button type="button" className="flex items-center focus:outline-none"
                                ...
                                <h3 className="relative mx-2 text-sm font-medium text-gray-700">
                                    {
                                        isMenuOpened &&
